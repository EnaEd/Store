...
namespace Store.DataAccessLayer.Migrations
{
    ...
    [Migration("20210311140454_add_required_to_author_entity")]
    partial class add_required_to_author_entity
    {
            ...
            modelBuilder.Entity("AuthorPrintingEdition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AuthorsId = new Guid("a8ccea31-4544-4c61-a4cf-c94044a41fb0"),
                            PrintingEditionsId = new Guid("ef6c2cc1-64e2-4196-9065-9cd59759f0be")
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccessLayer.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a8ccea31-4544-4c61-a4cf-c94044a41fb0"),
                            IsRemoved = false,
                            Name = "TestAuthor"
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccessLayer.Entities.PrintingEdition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ef6c2cc1-64e2-4196-9065-9cd59759f0be"),
                            Currency = "USD",
