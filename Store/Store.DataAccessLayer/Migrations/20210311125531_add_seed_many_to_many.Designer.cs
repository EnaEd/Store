...
namespace Store.DataAccessLayer.Migrations
{
    ...
    [Migration("20210311125531_add_seed_many_to_many")]
    partial class add_seed_many_to_many
    {
            ...
            modelBuilder.Entity("AuthorPrintingEdition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AuthorsId = new Guid("77a95f07-c2bd-46be-ab30-a67bd4ed7b5f"),
                            PrintingEditionsId = new Guid("b68096e2-8144-4c0d-a050-413fbffd163a")
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccessLayer.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("77a95f07-c2bd-46be-ab30-a67bd4ed7b5f"),
                            IsRemoved = false,
                            Name = "TestAuthor"
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccessLayer.Entities.PrintingEdition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b68096e2-8144-4c0d-a050-413fbffd163a"),
                            Currency = "USD",
