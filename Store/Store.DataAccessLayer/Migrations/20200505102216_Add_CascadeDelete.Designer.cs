...
namespace Store.DataAccessLayer.Migrations
{
    ...
    [Migration("20200505102216_Add_CascadeDelete")]
            ...
            modelBuilder.Entity("Store.DataAccessLayer.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ff87056f-42fe-4bf0-b146-97e9ffcfad2e"),
                            IsRemoved = false,
                            Name = "TestAuthor"
                        });
                });
            ...
            modelBuilder.Entity("Store.DataAccessLayer.Entities.PrintingEdition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("91de81d9-6193-42f6-9550-22f0cbd6bbe9"),
                            Currency = "USD",
            ...
            modelBuilder.Entity("Store.DataAccessLayer.Entities.AuthorInPrintingEdition", b =>
                {
                    ...
                    b.HasOne("Store.DataAccessLayer.Entities.PrintingEdition", "Edition")
                        .WithMany("AuthorInPrintingEditions")
