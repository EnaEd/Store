namespace Store.Shared.Constants
{
    public partial class Constant
    {
        public static class Info
        {
            ...
            public const string CREATE_AUTHOR_SUCCESS = "author successusfully created";
            public const string DELETE_AUTHOR_SUCCESS = "author successusfully removed";
            public const string UPDATE_AUTHOR_SUCCESS = "author successusfully updated";
